...
public class JavaAlgorithms {
    ...
    static public String longestCommonSubstring(@NotNull String first, @NotNull String second) {
        ...
        int startingLCSIndex = 0;
        int endingLCSIndex = 0;
        int[][] matrix = new int[firstChars.length + 1][secondChars.length + 1];
        int max = 0;
        ...
        while (matrix[startingLCSIndex][endingLCSIndex] > 0) {
            outputData.append(firstChars[startingLCSIndex - 1]);
            startingLCSIndex--;
            endingLCSIndex--;
        }
        return outputData.reverse().toString();
    }
